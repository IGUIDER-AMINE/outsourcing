...
const ResponsiveNavbar: FC<ResponsiveNavbar> = ({ nav, handelNav }) => {
  ...
  return (
    <div
      className={
        nav
          ? "md:hidden fixed left-0 top-0 w-full h-full bg-dark/50 backdrop-blur z-30"
          : ""
      }
    >
      <div
        className={
          nav
            ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-full dark:bg-[#171717] bg-white p-4 ease-in duration-500"
      ...
      >
        <div className="border-b border-gray pb-4">
          <div className="flex justify-between w-full items-center">
            ...
            <div
              onClick={handelNav}
              className="rounded-full shadow-md w-10 h-10 cursor-pointer flex items-center justify-center bg-brand"
            >
        ...
        <div className="py-5 flex flex-col justify-between  h-full">
          <div>
            ...
            <button className="btn btn-yellow mt-10">Contact Us</button>
          </div>
        </div>
      </div>
    </div>
